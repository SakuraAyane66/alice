...
$(document).on('copy', function (){
    showMessage('你都复制了些什么呀，转载要记得加上出处哦,CTL尝试加了自己的一点东西', 5000, true);
});

$('.waifu-tool .fui-home').click(function (){
    //window.location = 'https://www.fghrsh.net/';
    window.location = window.location.protocol+'//'+window.location.hostname+'/Homepage.html#'
});
...
$('.waifu-tool .fui-cross').click(function (){
    ...
    showMessage('愿你有一天能与重要的人重逢,CTL尝试了修改', 1300, true);
